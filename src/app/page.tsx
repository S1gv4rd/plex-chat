...
export default function Home() {
  ...
  return (
    <div className="app-height flex flex-col bg-background">
      {/* Offline indicator */}
      {libraryError && (
        <div role="alert" className="bg-red-500/10 border-b border-red-500/20 px-4 py-2 safe-top">
          <div className="max-w-2xl mx-auto flex items-center justify-center gap-2 text-red-400 text-sm">
